...
export const CONSTELLATION_STATUS_URL = `${CONSTELLATION_URL}/submissions/status`
...
export const HIPMA_STATUS_URL = `${HIPMA_URL}/submissions/status`
...
export const MIDWIFERY_STATUS_URL = `${MIDWIFERY_URL}/submissions/status`

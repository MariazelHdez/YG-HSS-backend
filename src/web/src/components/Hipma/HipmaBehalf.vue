...
export default {
    name: 'HipmaBehalf',
    props: ['hipma', 'hipmaDuplicated', 'hipmaFiles', 'panelModel'],
	data () {
		return {
			loader: null,
			loading: false,

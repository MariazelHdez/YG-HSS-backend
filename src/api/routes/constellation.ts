...
constellationRouter.get("/constellationHealth", EnsureAuthenticated, async (req: Request, res: Response) => {
        //let { id } = req.params;

        var constellationHealth =  db("constellation_health.constellation_health")
        ...
        constellationHealth.forEach(function (value: any) {
            ...
            /*
            value.diagnosis.forEach(function (valueDiagnosis: any) {
...
constellationRouter.get("/:constellationHealth_id",[param("constellationHealth_id").isInt().notEmpty()], async (req: Request, res: Response) => {
        ...
        _.forEach(constellationHealth.diagnosis, function(valueDiagnosis: any, key: any) {
            info_find = db("constellation_health.constellation_health_diagnosis_history").where({ id: valueDiagnosis });
...
constellationRouter.post("/constellationHealth/store", EnsureAuthenticated, async (req: Request, res: Response) => {
        ...
        var languages = db("constellation_health.constellation_health_language").where({ value: data.language_prefer_to_receive_services });
        ...
        var demographics = db("constellation_health.constellation_health_demographics").where({ value: data.demographics_groups });
        ...
        const idConstellation = await knex('constellation_health.constellation_health').returning('id').insert(constellationHealth);
...
function storeFamilyMembers(idConstellationHealth:any, arrayMembers:any){
        ...
        _.forEach(arrayMembers, function(value: any, key: any) {
            ...
            var languages = db("constellation_health.constellation_health_language").where({ value: arrayMembers['language_prefer_to_receive_services_family_member'] }).first('*');
            ...
            var demographics = db("constellation_health.constellation_health_demographics").where({ value: arrayMembers['demographics_groups_family_member'] }).first('*');

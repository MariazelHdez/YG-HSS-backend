...
AS SELECT 'bizont_edms_constellation_health'::text AS id,
  ...
  GROUP BY (to_char(ch.created_at, 'yyyymmdd'::text)), cd.val_str1, cc.val_str1, cp.val_str1
UNION
...
AS SELECT 'bizont_edms_constellation_health'::text AS id,
  ...
  GROUP BY (to_char(ch.created_at, 'yyyymm'::text)), (to_char(ch.created_at, 'WW'::text)), cd.val_str1, cc.val_str1, cp.val_str1
UNION
 SELECT 'bizont_edms_hipma'::text AS id,
    cd.val_str1::text AS department,
    cc.val_str1::text AS color,
